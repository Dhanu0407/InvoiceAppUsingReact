...
export default function Header({handlePrint,logo,setLogo}){
    return(
        <>
        <header className="flex flex-col items-center justify-center mb-5 xl:flex-row xl:justify-between">
<div>
  <h1 className="font-bold uppercase tracking-wide text-4xl mb-3">Invoicer</h1>
  {logo && <img src={logo} alt="Company Logo" style={{ maxHeight: '100px', maxWidth: '100%' }} />} {/* Display the logo if available */}
